...
import cardAccessEditValidatorCaseConstructor from "@/application/domain/service/card-access-edit-validator-service";
...
const cardAccessEditValidatorCase =
  cardAccessEditValidatorCaseConstructor(loadCard);

// 初始化基礎設施
const fastify = fastifyFactory(8080);
const io = SocketIoFactory(fastify);
const ySocketIo = YSocketIOFactory(
  io,
