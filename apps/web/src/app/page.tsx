  ...
  'spaceCards': [
    {
      ...
      'card': {
        ...
        'permission': 'Private',
        'title': '',
        'content': '<h1 class="bn-inline-content">Ziphus 使用方法</h1><h2 class="bn-inline-content">電腦</h2><ul><li><p class="bn-inline-content">右鍵按著，移動</p></li><li><p class="bn-inline-content">左鍵拖動卡片</p></li><li><p class="bn-inline-content">左鍵點擊卡片開始編輯</p></li><li><p class="bn-inline-content"></p></li></ul><p class="bn-inline-content"></p>',
        'width': 1280,
        'height': 1280,
        'illustrations': [],
        'drawings': [],
    ...
    },
    {
      ...
      'card': {
        ...
        'permission': 'Private',
        'title': '',
        'content': '<p class="bn-inline-content">Ｅ</p><p class="bn-inline-content"></p>',
        'width': 1280,
        'height': 1280,
        'illustrations': [],
        'drawings': [],
...
export default function Page(): JSX.Element {
  return (
    <div className="min-w-screen h-full min-h-screen w-full bg-[#0E0E0E] ">
      <Header />
      <main className=" container mx-auto py-4 flex flex-col items-center">
        <div className="gradient absolute top-0"></div>
        <h1 className='text-6xl mt-24 text-white font-bold'>
          視覺化的筆記平台
        </h1>
        <p className='text-2xl mt-12 text-white z-10'>
          簡單、直覺、免費
        </p>
        ...
        <div className='z-10'>
          <Link
            href={'/login'}
          >
            <Button className='mt-12 text-white' color='white' size='md' variant='outlined'>
            立即開始，完全免費
            </Button>
          </Link>
        </div>
        <main className="mt-12 h-[720px] rounded-xl overflow-hidden w-full">
